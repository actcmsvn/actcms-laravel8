...
namespace Actcmscss\Testing\Concerns;
...
trait MakesCallsToComponent
{
    ...
    {
        // This methhod simulates the calls Actcmscss's JavaScript
        ...
        // This is where either the pre-signed S3 url or the regular Actcmscss signed
        ...
        // Now we finish the upload with a final call to the Actcmscss component
