...
class FileUploadConfiguration
{
    ...
    public static function disk()
    {
        ...
        return config('actcmscss.temporary_file_upload.disk') ?: config('filesystems.default');
    }
    ...
    {
        $diskBeforeTestFake = config('actcmscss.temporary_file_upload.disk') ?: config('filesystems.default');
    ...
    {
        return Util::normalizeRelativePath(config('actcmscss.temporary_file_upload.directory') ?: 'actcmscss-tmp');
    }
    ...
    {
        return config('actcmscss.temporary_file_upload.middleware') ?: 'throttle:60,1';
    }

    public static function rules()
    {
        $rules = config('actcmscss.temporary_file_upload.rules');
    ...
    {
        return config('actcmscss.temporary_file_upload.max_upload_time') ?: 5;
    }
}
