...
use Actcmscss\Exceptions\MethodNotFoundException;
use Actcmscss\Exceptions\NonPublicComponentMethodCall;
use Actcmscss\Exceptions\PublicPropertyNotFoundException;
use Actcmscss\Exceptions\MissingFileUploadsTraitException;
use Illuminate\Database\Eloquent\Collection as EloquentCollection;
use Actcmscss\HydrationMiddleware\HashDataPropertiesForDirtyDetection;
use Actcmscss\Exceptions\CannotBindToModelDataWithoutValidationRuleException;
...
trait HandlesActions
{
    ...
    protected function callBeforeAndAfterSyncHooks($name, $value, $callback)
    {
        ...
        Actcmscss::dispatch('component.updating', $this, $name, $value);
        ...
        Actcmscss::dispatch('component.updated', $this, $name, $value);
    }
    ...
    public function callMethod($method, $params = [])
    {
        ...
        Actcmscss::dispatch('action.returned', $this, $method, $returned);
    }
