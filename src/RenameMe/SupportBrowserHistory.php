...
class SupportBrowserHistory
{
    ...
    {
        Actcmscss::listen('component.hydrate.initial', function ($component) {
        ...
        Actcmscss::listen('component.dehydrate.initial', function (Component $component, Response $response) {
        ...
        Actcmscss::listen('component.dehydrate.subsequent', function (Component $component, Response $response) {
    ...
    protected function getRouteFromReferer($referer)
    {
        try {
            ...
            return app('router')->getRoutes()->match(
                Request::create($referer, Actcmscss::originalMethod())
            );
    ...
    {
        return Actcmscss::isDefinitelyActcmscssRequest()
