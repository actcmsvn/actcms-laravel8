...
use Actcmscss\Macros\DuskBrowserMacros;
...
class TestCase extends BaseTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->tweakApplication(function () {
            // Autoload all Actcmscss components in this test suite.
            collect(File::allFiles(__DIR__))
                ...
                ->filter(function ($class) {
                    ...
                    app('Actcmscss')->component($componentClass);
                });

            Route::get(
                '/Actcmscss-dusk/tests/browser/sync-history-without-mount/{id}',
            ...
            Route::get('/Actcmscss-dusk/tests/browser/load-dynamic-component', function () {
            ...
            Route::post('/Actcmscss-dusk/tests/browser/dynamic-component', function () {
                return View::file(__DIR__ . '/DynamicComponentLoading/view-dynamic-component.blade.php');
            })->middleware('web')->name('dynamic-component');

            Route::get('/Actcmscss-dusk/{component}', function ($component) {
            ...
            Route::get('/with-authentication/Actcmscss-dusk/{component}', function ($component) {
                $class = urldecode($component);
            ...
            Route::get('/with-authorization/{post}/Actcmscss-dusk/{component}', function (Post $post, $component) {
                $class = urldecode($component);
            ...
            Actcmscss::addPersistentMiddleware(AllowListedMiddleware::class);
...
class User extends AuthUser
{
    ...
    protected $rows = [
        [
            'name' => 'First User',
            'email' => 'first@laravel-Actcmscss.com',
            'password' => '',
        ],
        [
            'name' => 'Second user',
            'email' => 'second@laravel-Actcmscss.com',
            'password' => '',
        ],
    ];
}
