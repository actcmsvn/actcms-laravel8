...
class ComponentMethodBindingsTest extends TestCase
{
    ...
    {
        Actcmscss::test(ComponentWithBindings::class, [
    ...
    {
        Actcmscss::test(ComponentWithMountInjections::class, [
            'foo',
            'model' => 'new model',
        ])->assertSeeText('http://localhost/some-url:new model:foo');

        Actcmscss::component(ComponentWithMountInjections::class);
    ...
    {
        $component = Actcmscss::test(ComponentWithBindings::class)
