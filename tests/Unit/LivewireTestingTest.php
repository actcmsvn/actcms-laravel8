...
class ActcmscssTestingTest extends TestCase
{
    /** @test */
    public function testing_Actcmscss_route_works_with_user_route_with_the_same_signature()
    {
        Route::get('/{param1}/{param2}', function() {
            throw new \Exception('I shouldn\'t get executed!');
        });

        Actcmscss::test(HasMountArguments::class, ['name' => 'foo']);
    }

    /** @test */
    public function method_accepts_arguments_to_pass_to_mount()
    {
        $component = app(ActcmscssManager::class)
    ...
    {
        // See for more info: https://github.com/calebporzio/Actcmscss/issues/62
        app(ActcmscssManager::class)
