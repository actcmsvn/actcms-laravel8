...
class ModelsCanBeSetAsPublicPropertiesTest extends TestCase
{
    ...
    public function an_eloquent_model_can_be_set_as_a_public_property()
    {
        ...
        Actcmscss::test(ComponentWithModelPublicProperty::class, ['model' => $model])
            ->assertSee('foo')
            ->call('refresh')
            ->assertSee('foo');
    }
    ...
    public function an_eloquent_model_cannot_be_hijacked_by_tampering_with_data()
    {
        ...
        $component = Actcmscss::test(ComponentWithModelPublicProperty::class, ['model' => $model]);
    ...
    public function an_eloquent_model_collection_can_be_set_as_a_public_property()
    {
        ...
        Actcmscss::test(ComponentWithModelsPublicProperty::class, ['models' => $models])
            ->assertSee('foo')
            ->assertSee('bar')
            ->call('refresh')
            ->assertSee('foo')
    ...
    public function a_sorted_eloquent_model_collection_can_be_set_as_a_public_property()
    {
        ...
        $component = Actcmscss::test(ComponentWithModelsPublicProperty::class, ['models' => $models]);
