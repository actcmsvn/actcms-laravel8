...
class MountComponentTest extends TestCase
{
    ...
    {
        $component = Actcmscss::test(ComponentWithOptionalParameters::class);
        $this->assertSame(null, $component->foo);
        $this->assertSame([], $component->bar);

        $component = Actcmscss::test(ComponentWithOptionalParameters::class, ['foo' => 'caleb']);
        $this->assertSame('caleb', $component->foo);
        $this->assertSame([], $component->bar);

        $component = Actcmscss::test(ComponentWithOptionalParameters::class, ['bar' => 'porzio']);
        $this->assertSame(null, $component->foo);
        $this->assertSame('porzio', $component->bar);

        $component = Actcmscss::test(ComponentWithOptionalParameters::class, ['foo' => 'caleb', 'bar' => 'porzio']);
        $this->assertSame('caleb', $component->foo);
        $this->assertSame('porzio', $component->bar);

        $component = Actcmscss::test(ComponentWithOptionalParameters::class, ['foo' => null, 'bar' => null]);
        $this->assertSame(null, $component->foo);
    ...
    {
        $fooBar = ['foo' => 10, 'bar' => 5];
        $componentWithFooBar = Actcmscss::test(ComponentWithOptionalParameters::class, $fooBar);
        $componentWithOnlyFoo = Actcmscss::test(ComponentWithOnlyFooParameter::class, $fooBar);
