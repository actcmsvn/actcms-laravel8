...
class PublicPropertiesAreInitializedTest extends TestCase
{
    ...
    {
        Actcmscss::test(UninitializedPublicPropertyComponent::class)
    ...
    {
        Actcmscss::test(InitializedPublicPropertyComponent::class)
...
PHP;
        ...
        Actcmscss::test(UninitializedPublicTypedPropertyComponent::class)
            ->assertSet('message', null);
    }
...
PHP;
        ...
        Actcmscss::test(UninitializedPublicTypedPropertyAfterRefreshComponent::class)
            ->call('$refresh')
            ->assertSet('message', null);
    }
...
PHP;
        ...
        Actcmscss::test(InitializedPublicTypedPropertyComponent::class)
