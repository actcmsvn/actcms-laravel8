...
class ComponentsAreSecureTest extends TestCase
{
    ...
    public function throws_method_not_found_exception_when_action_missing()
    {
        ...
        app('Actcmscss')->component('security-target', SecurityTargetStub::class);
        $component = app('Actcmscss')->test('security-target');
    ...
    public function component_name_cannot_be_tampered_with_on_frontend()
    {
        ...
        app('Actcmscss')->component('safe', SecurityTargetStub::class);
        app('Actcmscss')->component('unsafe', UnsafeComponentStub::class);
        $component = app('Actcmscss')->test('safe');
