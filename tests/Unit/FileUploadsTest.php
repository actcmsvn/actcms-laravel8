...
use Facades\Actcmscss\GenerateSignedUploadUrl;
use Actcmscss\Exceptions\MissingFileUploadsTraitException;
use Actcmscss\Exceptions\S3DoesntSupportMultipleFileUploads;
...
class FileUploadsTest extends TestCase
{
    ...
    public function component_must_have_file_uploads_trait_to_accept_file_uploads()
    {
        ...
        Actcmscss::test(NonFileUploadComponent::class)
    ...
    {
        config()->set('Actcmscss.temporary_file_upload.disk', 's3');

        $this->expectException(S3DoesntSupportMultipleFileUploads::class);

        Actcmscss::test(FileUploadComponent::class)
    ...
    public function can_remove_a_file_property()
    {
        ...
        $component = Actcmscss::test(FileUploadComponent::class)
            ->set('photo', $file);
    ...
    public function storing_a_file_returns_its_filename()
    {
        ...
        $storedFilename = Actcmscss::test(FileUploadComponent::class)
            ->set('photo', $file)
    ...
    /** @test */
    public function a_file_cant_be_larger_than_12mb_or_the_global_Actcmscss_uploader_will_fail()
    {
        Storage::fake('avatars');
    ...
    public function the_global_upload_validation_rules_can_be_configured_and_the_error_messages_show_as_normal_validation_errors_for_the_property()
    {
        ...
        config()->set('Actcmscss.temporary_file_upload.rules', 'file|max:50');
    ...
    /** @test */
    public function multiple_files_cant_be_larger_than_12mb_or_the_global_Actcmscss_uploader_will_fail()
    {
        Storage::fake('avatars');
    ...
    public function file_upload_global_validation_can_be_translated()
    {
        ...
        $test = Actcmscss::test(FileUploadComponent::class)
            ->set('file', $file)
    ...
    {
        $this->artisan('Actcmscss:configure-s3-upload-cleanup');
    ...
    {
        config()->set('Actcmscss.temporary_file_upload.middleware', 'Tests\Unit\DummyMiddleware');
    ...
    public function can_preview_a_temporary_file_with_a_temporary_signed_url()
    {
        ...
        $photo = Actcmscss::test(FileUploadComponent::class)
            ->set('photo', $file)
            ->viewData('photo');
    ...
    {
        config()->set('Actcmscss.temporary_file_upload.preview_mimes', ['pdf']);
    ...
    public function file_paths_cant_include_slashes_which_would_allow_them_to_access_other_private_directories()
    {
        ...
        // Try to hijack the photo property to a path outside the temporary Actcmscss directory root.
        $component->set('photo', 'Actcmscss-file:../dangerous.png')
            ->call('$refresh');
    }
    ...
    public function removing_first_item_from_array_of_temporary_uploaded_files_serializes_correctly()
    {
        ...
        $this->assertStringStartsWith('Actcmscss-files:', $component->get('photos'));
    ...
    public function removing_first_item_from_array_of_temporary_uploaded_files_serializes_correctly_with_in_array_public_property()
    {
        ...
        $component = Actcmscss::test(FileUploadInArrayComponent::class)
        ...
        $this->assertStringStartsWith('Actcmscss-files:', $component->get('obj.file_uploads'));
    ...
    public function it_can_upload_single_file_within_array_public_property()
    {
        ...
        $this->assertStringStartsWith('Actcmscss-file:', $component->get('obj.file_uploads'));
    }
