...
class ComponentEventsTest extends TestCase
{
    ...
    {
        $component = Actcmscss::test(ReceivesEvents::class);
    ...
    {
        $component = Actcmscss::test(ReceivesEventsWithSingleValueListener::class);
    ...
    {
        Actcmscss::test(DispatchesBrowserEvents::class)
                ->call('dispatchFoo')
    ...
    {
        Actcmscss::test(ReceivesEventsWithDynamicListeners::class, ['listener' => 'bob'])
                ->emit('bob', 'lob')
                ->assertSet('foo', 'lob');
    }
