...
class ComponentCanBeFilledTest extends TestCase
{
    ...
    {
        $component = Actcmscss::test(ComponentWithFillableProperties::class);
    ...
    {
        Actcmscss::test(ComponentWithFillableProperties::class)
    ...
    {
        $component = Actcmscss::test(ComponentWithFillableProperties::class, ['user' => new UserModel()]);
