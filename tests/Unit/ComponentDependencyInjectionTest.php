...
class ComponentDependencyInjectionTest extends TestCase
{
    ...
    {
        $component = Actcmscss::test(ComponentWithDependencyInjection::class, ['id' => 123]);
    ...
    {
        $component = Actcmscss::test(ComponentWithDependencyInjection::class);
    ...
    {
        $component = Actcmscss::test(CustomComponent::class);
