...
use Actcmscss\Exceptions\MissingRulesException;
use Actcmscss\ObjectPrybar;
use Sushi\Sushi;
...
class ComponentHasRulesPropertyTest extends TestCase
{
    ...
    {
        Actcmscss::test(ComponentWithRulesProperty::class)
            ->set('foo', '')
            ->call('save')
    ...
    public function validate_without_rules_property_and_no_args_throws_exception()
    {
        ...
        Actcmscss::test(ComponentWithoutRulesProperty::class)->call('save');
    }

    /** @test */
    public function can_validate_uniqueness_on_a_model()
    {
        Actcmscss::test(ComponentWithRulesPropertyAndModelWithUniquenessValidation::class)
            ->set('foo.name', 'bar')
            ->call('save')
    ...
    {
        Actcmscss::test(ComponentWithRulesPropertyAndModelUniquenessValidationWithIdExceptions::class)
