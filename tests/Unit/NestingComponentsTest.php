...
class NestingComponentsTest extends TestCase
{
    ...
    {
        app('Actcmscss')->component('parent', ParentComponentForNestingChildStub::class);
        app('Actcmscss')->component('child', ChildComponentForNestingStub::class);
        $component = app('Actcmscss')->test('parent');
    ...
    {
        app('Actcmscss')->component('parent', ParentComponentForNestingChildrenStub::class);
        app('Actcmscss')->component('child', ChildComponentForNestingStub::class);
        $component = app('Actcmscss')->test('parent');
    ...
    {
        app('Actcmscss')->component('parent', ParentComponentForNestingChildrenWithWireKeyStub::class);
        app('Actcmscss')->component('child', ChildComponentForNestingStub::class);
        $component = app('Actcmscss')->test('parent');
        ...
        return <<<'blade'
            <div>
                @foreach ($children as $child)
                    <Actcmscss:child :name="$child" :wire:key="$child" />
                @endforeach
            </div>
blade;
    }
