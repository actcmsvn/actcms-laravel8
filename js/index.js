...
class Actcmscss {
    ...
    start() {
        ...
        this.onLoadCallback()
        dispatch('actcmscss:load')

        document.addEventListener(
            'visibilitychange',
            () => {
                this.components.actcmscssIsInBackground = document.hidden
            },
            false
        )
...
dispatch('actcmscss:available')

export default Actcmscss
